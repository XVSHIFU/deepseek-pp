...
const pathAllowlist = new Map([
  ...
  ['scripts/dsh-web-command-acceptance.mjs', 'opt-in local real-web acceptance CLI uses fixed zh-CN operator instructions; extension runtime UI remains locale-backed'],
  ['scripts/dsh-web-file-edit-acceptance.mjs', 'opt-in local real-web acceptance CLI uses fixed zh-CN operator instructions; extension runtime UI remains locale-backed'],
  ['scripts/dsh-web-readonly-acceptance.mjs', 'opt-in local real-web acceptance CLI uses fixed zh-CN operator instructions; extension runtime UI remains locale-backed'],
