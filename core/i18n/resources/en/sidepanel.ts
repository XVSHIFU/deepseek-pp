export const sidepanel = {
  ...
  settings: {
    ...
    harnessDescription: 'Connect a local DeepSeek Harness to the current logged-in web model session.',
    ...
    harnessSection: 'DeepSeek Harness bridge',
    harnessSectionDescription: 'The extension connects only to 127.0.0.1 using the fixed Web Model Protocol path. The webpage login stays in the browser.',
    harnessEnabled: 'Enable local Harness bridge',
    harnessEnabledDescription: 'Disabled by default. This does not change the sidepanel chat, automation, MCP, or inline-agent backend.',
    ...
    harnessTokenRequired: 'A valid pairing token is required before enabling the bridge.',
    harnessTokenInvalid: 'Enter the exact base64url pairing token from the local Harness host.',
    harnessStatus: 'Connection status',
    harnessPhaseOffline: 'Offline',
    harnessPhaseConnecting: 'Connecting',
    harnessPhaseAuthenticating: 'Authenticating',
    harnessPhaseReady: 'Ready',
    harnessPhaseRetryWait: 'Waiting to retry',
    harnessPhaseNeedsPairing: 'Pairing required',
    harnessPhaseHandlerError: 'Request handler error',
    harnessPhaseProtocolError: 'Protocol error',
    harnessPhaseStopped: 'Stopped',
    harnessRefresh: 'Refresh',
    harnessDisconnect: 'Disconnect',
    harnessSave: 'Save',
    harnessSaved: 'Harness bridge settings saved.',
    harnessDisconnected: 'Harness bridge disconnected and disabled.',
    harnessConfigInvalid: 'The stored Harness bridge settings are corrupt or from a newer version. The original data was not overwritten.',
    harnessOperationFailed: 'Harness bridge operation failed.',
