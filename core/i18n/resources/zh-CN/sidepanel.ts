export const sidepanel = {
  ...
  settings: {
    ...
    harnessDescription: '让本机 DeepSeek Harness 使用当前已登录的网页模型会话。',
    ...
    harnessSection: 'DeepSeek Harness 桥接',
    harnessSectionDescription: '扩展只连接 127.0.0.1 的固定 Web Model Protocol 路径，网页登录状态始终留在浏览器内。',
    harnessEnabled: '启用本机 Harness 桥接',
    harnessEnabledDescription: '默认关闭，不改变侧边栏对话、自动化、MCP 或内联 Agent 的后端。',
    harnessPort: '回环端口',
    ...
    harnessTokenRequired: '启用桥接前必须提供有效配对令牌。',
    harnessTokenInvalid: '请输入本机 Harness Host 提供的完整 base64url 配对令牌。',
    harnessStatus: '连接状态',
    harnessPhaseOffline: '离线',
    harnessPhaseConnecting: '正在连接',
    harnessPhaseAuthenticating: '正在认证',
    harnessPhaseReady: '已连接',
    harnessPhaseRetryWait: '等待重试',
    harnessPhaseNeedsPairing: '需要重新配对',
    harnessPhaseHandlerError: '请求处理失败',
    harnessPhaseProtocolError: '协议错误',
    harnessPhaseStopped: '已停止',
    harnessRefresh: '刷新',
    harnessDisconnect: '断开',
    harnessSave: '保存',
    harnessSaved: 'Harness 桥接设置已保存。',
    harnessDisconnected: 'Harness 桥接已断开并停用。',
    harnessConfigInvalid: '已存的 Harness 桥接设置损坏或来自更高版本，原始数据未被覆盖。',
    harnessOperationFailed: 'Harness 桥接操作失败。',
    saveFailed: '保存失败',
    clearFailed: '清除失败',
