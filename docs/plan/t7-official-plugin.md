...
状态：`in_progress`（2026-09-07 启动；新阶段无已验证任务）
...
| T7.5 | 显式旧会话导入：预检、冲突、事务、保留源、导入后查看/继续 completed 会话 | T7.1 | `not_started` |
| T7.6 | DSH 插件包 + 浏览器包 + 简短说明；从包安装并完成官方真实验收 | T7.2–T7.5 | `not_started` |
